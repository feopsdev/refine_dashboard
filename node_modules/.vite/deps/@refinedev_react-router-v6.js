...
var D = { go: () => {
  ...
  var c;
  let e = useParams(), { pathname: t, search: r } = useLocation(), { resources: i } = (0, import_react2.useContext)(ut), { resource: s, action: n, matchedRoute: o } = import_react.default.useMemo(() => So(t, i), [i, t]);
...
var G = ({ children: e }) => {
  let { resources: t } = $(), r = import_react3.default.useMemo(() => N(t), [t]);
  return e ? e(r) : import_react3.default.createElement(Routes, null, r);
};
var q = ({ resource: e, meta: t }) => {
  let r = ft(), { resource: i, resources: s } = $(e), n = i || s.find((o) => o.list);
  if (n) {
...
function ce({ handler: e }) {
  var m;
  let t = useLocation(), { action: r, id: i, params: s, pathname: n, resource: o } = ge(), a = _(), c = Lt(), f = (o == null ? void 0 : o.identifier) ?? (o == null ? void 0 : o.name), u = (o == null ? void 0 : o.label) ?? ((m = o == null ? void 0 : o.meta) == null ? void 0 : m.label) ?? c(f, r === "list" ? "plural" : "singular");
