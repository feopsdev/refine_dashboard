...
var t = (e2, o2) => er(e2, "name", { value: o2, configurable: true });
var Te = t(({ action: e2, resource: o2, onMutationSuccess: n2, onMutationError: r, autoSave: s, submitOnEnter: l = false, warnWhenUnsavedChanges: i, redirect: d, successNotification: c, errorNotification: y, meta: p, metaData: P, queryMeta: T, mutationMeta: x, liveMode: F, liveParams: u, mutationMode: f, dataProviderName: h, onLiveEvent: m, invalidates: C, undoableTimeout: a, queryOptions: S2, createMutationOptions: v, updateMutationOptions: B, id: k, overtimeOptions: g, optimisticUpdateMap: D, disableServerSideValidation: R = false } = {}) => {
  var ne, ee2;
  let { options: E } = oe(), z2 = (E == null ? void 0 : E.disableServerSideValidation) || R, b = _(), [W] = form_default.useForm(), O = useForm({ form: W }), { form: U } = O, A = SP({ onMutationSuccess: n2 || void 0, onMutationError: async (N, oe2, re) => {
    if (z2) {
      r == null || r(N, oe2, re);
      return;
    }
    let Z = [], ue = U.getFieldsValue();
    Z = Object.keys(xr(ue)).map((he) => ({ name: jo(he), errors: void 0 })), U.setFields(Z);
    let Ne = N == null ? void 0 : N.errors;
    for (let he in Ne) {
      let ye = Ne[he], Qe = [];
      Array.isArray(ye) && (Qe = ye), typeof ye == "string" && (Qe = [ye]), typeof ye == "boolean" && ye && (Qe = ["Field is not valid."]), typeof ye == "object" && "key" in ye && (Qe = [b(ye.key, ye.message)]), Z.push({ name: jo(he), errors: Qe });
    }
    U.setFields([...Z]), r == null || r(N, oe2, re);
  }, redirect: d, action: e2, resource: o2, successNotification: c, errorNotification: y, meta: S(p, P), metaData: S(p, P), queryMeta: T, mutationMeta: x, liveMode: F, liveParams: u, mutationMode: f, dataProviderName: h, onLiveEvent: m, invalidates: C, undoableTimeout: a, queryOptions: S2, createMutationOptions: v, updateMutationOptions: B, id: k, overtimeOptions: g, optimisticUpdateMap: D, autoSave: s }), { formLoading: X, onFinish: L, queryResult: I, id: M, onFinishAutoSave: j } = A, { warnWhenUnsavedChanges: _2, setWarnWhen: $2 } = Ht(), H = i ?? _2;
  import_react74.default.useEffect(() => {
    U.resetFields();
  }, [(ne = I == null ? void 0 : I.data) == null ? void 0 : ne.data, M]);
  let q = t((N) => {
    l && N.key === "Enter" && U.submit();
  }, "onKeyUp"), K = t((N, oe2) => {
    if (N && H && $2(true), s != null && s.enabled) {
      $2(false);
  ...
  return { form: O.form, formProps: { ...O.formProps, onFinish: (N) => L(N).catch((oe2) => oe2), onKeyUp: q, onValuesChange: K, initialValues: (ee2 = I == null ? void 0 : I.data) == null ? void 0 : ee2.data }, saveButtonProps: J, ...A, onFinish: async (N) => await L(N ?? O.form.getFieldsValue(true)) };
}, "useForm");
var et = t(({ modalProps: e2 = {} } = {}) => {
  let { show: o2, close: n2, visible: r } = Ah({ defaultVisible: e2.open });
  return { modalProps: { ...e2, onCancel: (s) => {
    var l;
    (l = e2.onCancel) == null || l.call(e2, s), n2();
  }, open: r, visible: r }, show: o2, close: n2 };
}, "useModal");
var tt = t(({ syncWithLocation: e2, defaultVisible: o2 = false, autoSubmitClose: n2 = true, autoResetForm: r = true, autoSave: s, invalidates: l, ...i }) => {
  var $2, H;
  let [d, c] = import_react75.default.useState(false), y = be(), { resource: p, action: P, identifier: T } = $(i.resource), x = ge(), F = fe(), u = Lt(), f = i.action ?? P ?? "", h = !(typeof e2 == "object" && (e2 == null ? void 0 : e2.syncId) === false), m = typeof e2 == "object" && "key" in e2 ? e2.key : p && f && e2 ? `modal-${T}-${f}` : void 0, C = Te({ meta: { ...m ? { [m]: void 0 } : {}, ...i.meta }, autoSave: s, invalidates: l, ...i }), { form: a, formProps: S2, id: v, setId: B, formLoading: k, onFinish: g, autoSaveProps: D } = C, R = _(), { warnWhen: E, setWarnWhen: z2 } = Ht(), { show: b, close: W, modalProps: O } = et({ modalProps: { open: o2 } }), U = O.open || false, A = { modalProps: O, form: a, formLoading: k, formProps: S2, formResult: void 0, formValues: a.getFieldsValue, defaultFormValuesLoading: false, initialValues: {}, submit: g, close: W, open: O.open || false, show: b, visible: U };
  import_react75.default.useEffect(() => {
    var q, K, J, ne;
    if (d === false && m) {
      let ee2 = (K = (q = x == null ? void 0 : x.params) == null ? void 0 : q[m]) == null ? void 0 : K.open;
      if (typeof ee2 == "boolean" ? ee2 && b() : typeof ee2 == "string" && ee2 === "true" && b(), h) {
        let N = (ne = (J = x == null ? void 0 : x.params) == null ? void 0 : J[m]) == null ? void 0 : ne.id;
        N && (B == null || B(N));
      }
      c(true);
    }
  }, [m, x, h, B]), import_react75.default.useEffect(() => {
    var q;
    d === true && (U && m ? F({ query: { [m]: { ...(q = x == null ? void 0 : x.params) == null ? void 0 : q[m], open: true, ...h && v && { id: v } } }, options: { keepQuery: true }, type: "replace" }) : m && !U && F({ query: { [m]: void 0 }, options: { keepQuery: true }, type: "replace" }));
  }, [v, U, b, m, h]);
  ...
  }, [E, D.status]), I = (0, import_react75.useCallback)((q) => {
    typeof q < "u" && (B == null || B(q)), (!(f === "edit" || f === "clone") || (typeof q < "u" || typeof v < "u")) && A.show();
  }, [v]), { visible: M, ...j } = O, _2 = { open: M, ...j };
  return { ...C, ...A, show: I, close: L, open: U, formProps: { ...S2, ...C.formProps, onValuesChange: S2 == null ? void 0 : S2.onValuesChange, onKeyUp: S2 == null ? void 0 : S2.onKeyUp, onFinish: async (q) => {
    await g(q), n2 && W(), r && a.resetFields();
  } }, modalProps: { ..._2, width: "1000px", okButtonProps: X, title: R(`${T}.titles.${i.action}`, `${u(`${i.action} ${(($2 = p == null ? void 0 : p.meta) == null ? void 0 : $2.label) ?? ((H = p == null ? void 0 : p.options) == null ? void 0 : H.label) ?? (p == null ? void 0 : p.label) ?? T}`, "singular")}`), okText: R("buttons.save", "Save"), cancelText: R("buttons.cancel", "Cancel"), onCancel: L, forceRender: true }, formLoading: k };
}, "useModalForm");
var nt = t(({ syncWithLocation: e2, defaultVisible: o2 = false, autoSubmitClose: n2 = true, autoResetForm: r = true, autoSave: s, invalidates: l, ...i }) => {
  let d = be(), [c, y] = import_react76.default.useState(false), { visible: p, show: P, close: T } = Ah({ defaultVisible: o2 }), { resource: x, action: F, identifier: u } = $(i.resource), f = ge(), h = fe(), m = i.action ?? F ?? "", C = !(typeof e2 == "object" && (e2 == null ? void 0 : e2.syncId) === false), a = typeof e2 == "object" && "key" in e2 ? e2.key : x && m && e2 ? `drawer-${(x == null ? void 0 : x.identifier) ?? (x == null ? void 0 : x.name)}-${m}` : void 0, S2 = Te({ meta: { ...a ? { [a]: void 0 } : {}, ...i.meta }, autoSave: s, invalidates: l, ...i }), { form: v, formProps: B, formLoading: k, id: g, setId: D, onFinish: R, autoSaveProps: E } = S2;
  import_react76.default.useEffect(() => {
    ...
    if (c === false && a) {
      ...
      if (typeof _2 == "boolean" ? _2 ? P() : T() : typeof _2 == "string" && _2 === "true" && P(), C) {
        let $2 = (j = (M = f == null ? void 0 : f.params) == null ? void 0 : M[a]) == null ? void 0 : j.id;
        $2 && (D == null || D($2));
      }
      y(true);
    }
    ...
    var L;
    c === true && (p && a ? h({ query: { [a]: { ...(L = f == null ? void 0 : f.params) == null ? void 0 : L[a], open: true, ...C && g && { id: g } } }, options: { keepQuery: true }, type: "replace" }) : a && !p && h({ query: { [a]: void 0 }, options: { keepQuery: true }, type: "replace" }));
  }, [g, p, P, T, a, C, c]);
...
var kr = t((e2, o2, n2 = "eq") => Gn(e2, o2, n2), "getDefaultFilter");
var fo = t((e2) => {
  let o2 = [];
  if (Array.isArray(e2))
    e2.sort((n2, r) => {
...
var xe = t(({ to: e2, element: o2 }) => {
  let { Link: n2 } = ae(), r = ee(), s = yt();
  return import_react78.default.createElement(r === "legacy" ? n2 : s, { to: e2, replace: false, onClick: (i) => {
    i.preventDefault();
  } }, o2);
}, "PaginationLink");
var go = t(({ onSearch: e2, initialCurrent: o2, initialPageSize: n2, hasPagination: r = true, pagination: s, initialSorter: l, permanentSorter: i, initialFilter: d, permanentFilter: c, defaultSetFilterBehavior: y, filters: p, sorters: P, syncWithLocation: T, resource: x, successNotification: F, errorNotification: u, queryOptions: f, liveMode: h, onLiveEvent: m, liveParams: C, meta: a, metaData: S2, dataProviderName: v } = {}) => {
  let { tableQueryResult: B, current: k, setCurrent: g, pageSize: D, setPageSize: R, filters: E, setFilters: z2, sorters: b, setSorters: W, sorter: O, setSorter: U, createLinkForSyncWithLocation: A, pageCount: X, overtime: L } = YC({ permanentSorter: i, permanentFilter: c, initialCurrent: o2, initialPageSize: n2, pagination: s, hasPagination: r, filters: p, sorters: P, initialSorter: l, initialFilter: d, syncWithLocation: T, resource: x, defaultSetFilterBehavior: y, successNotification: F, errorNotification: u, queryOptions: f, liveMode: h, onLiveEvent: m, liveParams: C, meta: S(a, S2), metaData: S(a, S2), dataProviderName: v }), I = grid_default.useBreakpoint(), [M] = form_default.useForm(), j = useForm({ form: M }), _2 = Fs(h), $2 = r === false ? "off" : "server", H = ((s == null ? void 0 : s.mode) ?? $2) !== "off", q = S(p == null ? void 0 : p.initial, d), { data: K, isFetched: J, isLoading: ne } = B, ee2 = t((re, Z, ue) => {
    ...
    if (Z === "page")
      return (0, import_react77.createElement)(xe, { to: de, element: `${re}` });
    if (Z === "next" || Z === "prev")
      return (0, import_react77.createElement)(xe, { to: de, element: ue });
    if (Z === "jump-next" || Z === "jump-prev") {
      let he = (Ne = ue == null ? void 0 : ue.props) == null ? void 0 : Ne.children;
      return (0, import_react77.createElement)(xe, { to: de, element: import_react77.Children.count(he) > 1 ? (0, import_react77.createElement)(import_react77.Fragment, {}, he) : he });
    }
    return ue;
  }, pageSize: D, current: k, simple: !I.sm, position: I.sm ? ["bottomRight"] : ["bottomCenter"], total: K == null ? void 0 : K.total } : false, "antdPagination");
  return { searchFormProps: { ...j.formProps, onFinish: N }, tableProps: { dataSource: K == null ? void 0 : K.data, loading: _2 === "auto" ? ne : !J, onChange: ee2, pagination: oe2(), scroll: { x: true } }, tableQueryResult: B, sorters: b, sorter: O, filters: E, setSorters: W, setSorter: U, setFilters: z2, current: k, setCurrent: g, pageSize: D, setPageSize: R, pageCount: X, createLinkForSyncWithLocation: A, overtime: L };
}, "useTable");
var Nr = t(({ autoSubmitClose: e2 = true, ...o2 } = {}) => {
  let n2 = go({ ...o2, successNotification: void 0, errorNotification: void 0 }), r = Te({ ...o2, action: "edit", redirect: false }), { id: s, setId: l, saveButtonProps: i } = r, d = { onClick: () => {
    l(void 0);
...
var ef = t((e2) => {
  let { queryResult: o2, defaultValueQueryResult: n2, onSearch: r, options: s } = QC(e2);
...
var df = t(({ resource: e2, sort: o2, sorters: n2, filters: r, optionLabel: s, optionValue: l, queryOptions: i, fetchSize: d, pagination: c, liveMode: y, defaultValue: p, onLiveEvent: P, liveParams: T, meta: x, metaData: F, dataProviderName: u }) => {
  let { queryResult: f, options: h } = QC({ resource: e2, sort: o2, sorters: n2, filters: r, optionLabel: s, optionValue: l, queryOptions: i, fetchSize: d, pagination: c, liveMode: y, defaultValue: p, onLiveEvent: P, liveParams: T, meta: S(x, F), metaData: S(x, F), dataProviderName: u });
  return { checkboxGroupProps: { options: h, defaultValue: p }, queryResult: f };
}, "useCheckboxGroup");
var Pf = t(({ resource: e2, sort: o2, sorters: n2, filters: r, optionLabel: s, optionValue: l, queryOptions: i, fetchSize: d, pagination: c, liveMode: y, defaultValue: p, onLiveEvent: P, liveParams: T, meta: x, metaData: F, dataProviderName: u }) => {
  let { queryResult: f, options: h } = QC({ resource: e2, sort: o2, sorters: n2, filters: r, optionLabel: s, optionValue: l, queryOptions: i, fetchSize: d, pagination: c, liveMode: y, defaultValue: p, onLiveEvent: P, liveParams: T, meta: S(x, F), metaData: S(x, F), dataProviderName: u });
  return { radioGroupProps: { options: h, defaultValue: p }, queryResult: f };
}, "useRadioGroup");
var Uf = t(({ resource: e2, resourceName: o2, mapData: n2 = t((p) => p, "mapData"), paparseOptions: r, batchSize: s = Number.MAX_SAFE_INTEGER, onFinish: l, meta: i, metaData: d, dataProviderName: c, onProgress: y } = {}) => {
  let p = _(), { resource: P } = $(e2 ?? o2), { mutationResult: T, isLoading: x, handleChange: F } = wh({ resource: (P == null ? void 0 : P.identifier) ?? (P == null ? void 0 : P.name), mapData: n2, paparseOptions: r, batchSize: s, meta: S(i, d), metaData: S(i, d), dataProviderName: c, onFinish: l, onProgress: y ?? (({ totalAmount: u, processedAmount: f }) => {
    if (u > 0 && f > 0) {
      let h = import_react79.default.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: "-7px" } }, import_react79.default.createElement(progress_default, { type: "circle", percent: Math.floor(f / u * 100), size: 50, strokeColor: "#1890ff", status: "normal" }), import_react79.default.createElement("span", { style: { marginLeft: 8, width: "100%" } }, p("notifications.importProgress", { processed: f, total: u }, `Importing: ${f}/${u}`)));
      notification_default.open({ description: h, message: null, key: `${P}-import`, duration: 0 }), f >= u, f === u && setTimeout(() => {
        notification_default.destroy(`${P}-import`);
      }, 4500);
    }
  }) });
  return { uploadProps: { onChange: F, beforeUpload: () => false, showUploadList: false, accept: ".csv" }, buttonProps: { type: "default", loading: x }, mutationResult: T, isLoading: x };
}, "useImport");
var en = t(({ resource: e2, initialCurrent: o2, initialPageSize: n2, pagination: r, hasPagination: s = true, initialSorter: l, permanentSorter: i, initialFilter: d, permanentFilter: c, defaultSetFilterBehavior: y, filters: p, sorters: P, onSearch: T, queryOptions: x, syncWithLocation: F, successNotification: u, errorNotification: f, liveMode: h, onLiveEvent: m, liveParams: C, meta: a, metaData: S2, dataProviderName: v } = {}) => {
  let { sorters: B, sorter: k, filters: g, current: D, pageSize: R, pageCount: E, setFilters: z2, setCurrent: b, setPageSize: W, setSorter: O, setSorters: U, createLinkForSyncWithLocation: A, tableQueryResult: X, overtime: L } = YC({ resource: e2, initialSorter: l, permanentSorter: i, initialFilter: d, permanentFilter: c, filters: p, sorters: P, defaultSetFilterBehavior: y, initialCurrent: o2, initialPageSize: n2, queryOptions: x, successNotification: u, errorNotification: f, liveMode: h, onLiveEvent: m, liveParams: C, meta: S(a, S2), metaData: S(a, S2), syncWithLocation: F, dataProviderName: v, pagination: r, hasPagination: s }), I = s === false ? "off" : "server", M = ((r == null ? void 0 : r.mode) ?? I) !== "off", j = grid_default.useBreakpoint(), _2 = Fs(h), [$2] = form_default.useForm(), { data: H, isFetched: q, isLoading: K } = X, J = t((N, oe2) => {
    M && (b(N), W(oe2 || 10));
  }, "onChange"), ne = t(async (N) => {
    if (T) {
      let oe2 = await T(N);
      return M && (b == null || b(1)), z2(oe2);
    }
  }, "onFinish"), ee2 = t(() => M ? { itemRender: (N, oe2, re) => {
    var ue;
    let Z = A({ pagination: { pageSize: R, current: N }, sorters: B, filters: g });
    if (oe2 === "page")
      return (0, import_react80.createElement)(xe, { to: Z, element: `${N}` });
    if (oe2 === "next" || oe2 === "prev")
      return (0, import_react80.createElement)(xe, { to: Z, element: re });
    if (oe2 === "jump-next" || oe2 === "jump-prev") {
      let de = (ue = re == null ? void 0 : re.props) == null ? void 0 : ue.children;
      return (0, import_react80.createElement)(xe, { to: Z, element: import_react80.Children.count(de) > 1 ? (0, import_react80.createElement)(import_react80.Fragment, {}, de) : de });
    }
    return re;
  }, pageSize: R, current: D, simple: !j.sm, total: H == null ? void 0 : H.total, onChange: J } : false, "antdPagination");
  return { searchFormProps: { form: $2, onFinish: ne }, listProps: { dataSource: H == null ? void 0 : H.data, loading: _2 === "auto" ? K : !q, pagination: ee2() }, queryResult: X, filters: g, setFilters: z2, sorter: k, setSorter: O, sorters: B, setSorters: U, current: D, setCurrent: b, pageSize: R, setPageSize: W, pageCount: E, createLinkForSyncWithLocation: A, overtime: L };
}, "useSimpleList");
var Jf = t(() => {
  let [e2, o2] = (0, import_react81.useState)(false), n2 = (0, import_react81.useCallback)((r) => {
    nn(r.fileList).includes(true) ? o2(true) : o2(false);
  }, []);
  return (0, import_react81.useMemo)(() => ({ isLoading: e2, onChange: n2 }), [e2]);
}, "useFileUploadState");
var nn = t((e2) => e2.map((o2) => {
  switch (o2.status) {
    case "uploading":
      return true;
    default:
...
var ho = t(({ children: e2, initialSiderCollapsed: o2 }) => {
...
var Sy = { open: ({ key: e2, message: o2, description: n2, type: r, cancelMutation: s, undoableTimeout: l }) => {
...
var Co = t(({ Title: e2, render: o2, meta: n2 }) => {
  let [r, s] = (0, import_react88.useState)(false), [l, i] = (0, import_react88.useState)(false), d = so(), c = ee(), y = yt(), { warnWhen: p, setWarnWhen: P } = Ht(), { Link: T } = ae(), x = c === "legacy" ? T : y, F = kn(), u = _(), { menuItems: f, selectedKey: h, defaultOpenKeys: m } = nu({ meta: n2 }), C = grid_default.useBreakpoint(), { hasDashboard: a } = oe(), S2 = Y(), { mutate: v } = Dr({ v3LegacyAuthProviderCompatible: !!(S2 != null && S2.isLegacy) }), B = typeof C.lg > "u" ? false : !C.lg, k = e2 ?? F ?? Fo, g = t((A, X) => A.map((L) => {
    let { icon: I, label: M, route: j, key: _2, name: $2, children: H, parentName: q, meta: K, options: J } = L;
    if (H.length > 0)
      return import_react88.default.createElement(Qu, { key: L.key, resource: $2.toLowerCase(), action: "list", params: { resource: L } }, import_react88.default.createElement(menu_default.SubMenu, { key: L.key, icon: I ?? import_react88.default.createElement(UnorderedListOutlined_default, null), title: M }, g(H, X)));
    let ne = _2 === X, ee2 = !(S(K == null ? void 0 : K.parent, J == null ? void 0 : J.parent, q) !== void 0 && H.length === 0);
    return import_react88.default.createElement(Qu, { key: L.key, resource: $2.toLowerCase(), action: "list", params: { resource: L } }, import_react88.default.createElement(menu_default.Item, { key: L.key, style: { fontWeight: ne ? "bold" : "normal" }, icon: I ?? (ee2 && import_react88.default.createElement(UnorderedListOutlined_default, null)) }, import_react88.default.createElement(x, { to: j ?? "" }, M), !r && ne && import_react88.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), D = t(() => {
    p ? window.confirm(u("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (P(false), v()) : v();
  }, "handleLogout"), R = d && import_react88.default.createElement(menu_default.Item, { key: "logout", onClick: D, icon: import_react88.default.createElement(LogoutOutlined_default, null) }, u("buttons.logout", "Logout")), E = a ? import_react88.default.createElement(menu_default.Item, { key: "dashboard", style: { fontWeight: h === "/" ? "bold" : "normal" }, icon: import_react88.default.createElement(DashboardOutlined_default, null) }, import_react88.default.createElement(x, { to: "/" }, u("dashboard.title", "Dashboard")), !r && h === "/" && import_react88.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, z2 = g(f, h), b = t(() => o2 ? o2({ dashboard: E, items: z2, logout: R, collapsed: r }) : import_react88.default.createElement(import_react88.default.Fragment, null, E, z2, R), "renderSider"), W = t(() => import_react88.default.createElement(import_react88.default.Fragment, null, import_react88.default.createElement(menu_default, { theme: "dark", selectedKeys: h ? [h] : [], defaultOpenKeys: m, mode: "inline", onClick: () => {
    i(false), C.lg || s(true);
  } }, b())), "renderMenu"), O = t(() => import_react88.default.createElement(import_react88.default.Fragment, null, import_react88.default.createElement(drawer_default, { open: l, onClose: () => i(false), placement: "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react88.default.createElement(layout_default, null, import_react88.default.createElement(layout_default.Sider, { style: { height: "100vh", overflow: "hidden" } }, import_react88.default.createElement(k, { collapsed: false }), W()))), import_react88.default.createElement(button_default, { style: ft, size: "large", onClick: () => i(true), icon: import_react88.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
...
var Bo = t(() => {
  let e2 = Y(), { data: o2 } = Xr({ v3LegacyAuthProviderCompatible: !!(e2 != null && e2.isLegacy) });
...
var On = t(({ children: e2, Header: o2, Sider: n2, Title: r, Footer: s, OffLayoutArea: l }) => {
  let i = grid_default.useBreakpoint(), d = n2 ?? Co, c = o2 ?? Bo, y = typeof i.sm > "u" ? true : i.sm;
...
var Lo = t(({ Title: e2, render: o2, meta: n2 }) => {
  let { token: r } = theme_default.useToken(), [s, l] = (0, import_react92.useState)(false), [i, d] = (0, import_react92.useState)(false), c = so(), y = ee(), p = yt(), { warnWhen: P, setWarnWhen: T } = Ht(), { Link: x } = ae(), F = y === "legacy" ? x : p, u = kn(), f = _(), { menuItems: h, selectedKey: m, defaultOpenKeys: C } = nu({ meta: n2 }), a = grid_default.useBreakpoint(), { hasDashboard: S2 } = oe(), v = Y(), { mutate: B } = Dr({ v3LegacyAuthProviderCompatible: !!(v != null && v.isLegacy) }), k = typeof a.lg > "u" ? false : !a.lg, g = e2 ?? u ?? ko, D = t((A, X) => A.map((L) => {
    let { icon: I, label: M, route: j, key: _2, name: $2, children: H, parentName: q, meta: K, options: J } = L;
    if (H.length > 0)
      return import_react92.default.createElement(Qu, { key: L.key, resource: $2.toLowerCase(), action: "list", params: { resource: L } }, import_react92.default.createElement(menu_default.SubMenu, { key: L.key, icon: I ?? import_react92.default.createElement(UnorderedListOutlined_default, null), title: M }, D(H, X)));
    let ne = _2 === X, ee2 = !(S(K == null ? void 0 : K.parent, J == null ? void 0 : J.parent, q) !== void 0 && H.length === 0);
    return import_react92.default.createElement(Qu, { key: L.key, resource: $2.toLowerCase(), action: "list", params: { resource: L } }, import_react92.default.createElement(menu_default.Item, { key: L.key, icon: I ?? (ee2 && import_react92.default.createElement(UnorderedListOutlined_default, null)) }, import_react92.default.createElement(F, { to: j ?? "" }, M), !s && ne && import_react92.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), R = t(() => {
    P ? window.confirm(f("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (T(false), B()) : B();
  }, "handleLogout"), E = c && import_react92.default.createElement(menu_default.Item, { key: "logout", onClick: () => R(), icon: import_react92.default.createElement(LogoutOutlined_default, null) }, f("buttons.logout", "Logout")), z2 = S2 ? import_react92.default.createElement(menu_default.Item, { key: "dashboard", icon: import_react92.default.createElement(DashboardOutlined_default, null) }, import_react92.default.createElement(F, { to: "/" }, f("dashboard.title", "Dashboard")), !s && m === "/" && import_react92.default.createElement("div", { className: "ant-menu-tree-arrow" })) : null, b = D(h, m), W = t(() => o2 ? o2({ dashboard: z2, items: b, logout: E, collapsed: s }) : import_react92.default.createElement(import_react92.default.Fragment, null, z2, b, E), "renderSider"), O = t(() => import_react92.default.createElement(import_react92.default.Fragment, null, import_react92.default.createElement(menu_default, { selectedKeys: m ? [m] : [], defaultOpenKeys: C, mode: "inline", style: { marginTop: "8px", border: "none" }, onClick: () => {
    d(false), a.lg || l(true);
  } }, W())), "renderMenu"), U = t(() => import_react92.default.createElement(import_react92.default.Fragment, null, import_react92.default.createElement(drawer_default, { open: i, onClose: () => d(false), placement: "left", closable: false, width: 200, bodyStyle: { padding: 0 }, maskClosable: true }, import_react92.default.createElement(layout_default, null, import_react92.default.createElement(layout_default.Sider, { style: { height: "100vh", overflow: "hidden", backgroundColor: r.colorBgContainer, borderRight: `1px solid ${r.colorBgElevated}` } }, import_react92.default.createElement("div", { style: { width: "200px", padding: "0 16px", display: "flex", justifyContent: "flex-start", alignItems: "center", height: "64px", backgroundColor: r.colorBgElevated } }, import_react92.default.createElement(g, { collapsed: false })), O()))), import_react92.default.createElement(button_default, { style: bt, size: "large", onClick: () => d(true), icon: import_react92.default.createElement(BarsOutlined_default, null) })), "renderDrawerSider");
...
var Bt = { borderTopLeftRadius: 0, borderBottomLeftRadius: 0, position: "fixed", top: 64, zIndex: 999 };
var Ro = t(({ Title: e2, render: o2, meta: n2, fixed: r, activeItemDisabled: s = false }) => {
  let { token: l } = theme_default.useToken(), { siderCollapsed: i, setSiderCollapsed: d, mobileSiderOpen: c, setMobileSiderOpen: y } = ct2(), p = so(), P = ee(), T = yt(), { warnWhen: x, setWarnWhen: F } = Ht(), { Link: u } = ae(), f = P === "legacy" ? u : T, h = kn(), m = _(), { menuItems: C, selectedKey: a, defaultOpenKeys: S2 } = nu({ meta: n2 }), v = grid_default.useBreakpoint(), { hasDashboard: B } = oe(), k = Y(), { mutate: g } = Dr({ v3LegacyAuthProviderCompatible: !!(k != null && k.isLegacy) }), D = typeof v.lg > "u" ? false : !v.lg, R = e2 ?? h ?? ce, E = t((I, M) => I.map((j) => {
    let { icon: _2, label: $2, route: H, key: q, name: K, children: J, parentName: ne, meta: ee2, options: N } = j;
    if (J.length > 0)
      return import_react96.default.createElement(Qu, { key: j.key, resource: K.toLowerCase(), action: "list", params: { resource: j } }, import_react96.default.createElement(menu_default.SubMenu, { key: j.key, icon: _2 ?? import_react96.default.createElement(UnorderedListOutlined_default, null), title: $2 }, E(J, M)));
    let oe2 = q === M, re = !(S(ee2 == null ? void 0 : ee2.parent, N == null ? void 0 : N.parent, ne) !== void 0 && J.length === 0), Z = s && oe2 ? { pointerEvents: "none" } : {};
    return import_react96.default.createElement(Qu, { key: j.key, resource: K.toLowerCase(), action: "list", params: { resource: j } }, import_react96.default.createElement(menu_default.Item, { key: j.key, icon: _2 ?? (re && import_react96.default.createElement(UnorderedListOutlined_default, null)), style: Z }, import_react96.default.createElement(f, { to: H ?? "", style: Z }, $2), !i && oe2 && import_react96.default.createElement("div", { className: "ant-menu-tree-arrow" })));
  }), "renderTreeView"), z2 = t(() => {
    x ? window.confirm(m("warnWhenUnsavedChanges", "Are you sure you want to leave? You have unsaved changes.")) && (F(false), g()) : g();
...
var Uo = t(({ isSticky: e2, sticky: o2 }) => {
  let { token: n2 } = theme_default.useToken(), r = Y(), { data: s } = Xr({ v3LegacyAuthProviderCompatible: !!(r != null && r.isLegacy) });
  ...
  return S(o2, e2) && (i.position = "sticky", i.top = 0, i.zIndex = 1), import_react97.default.createElement(layout_default.Header, { style: i }, import_react97.default.createElement(space_default, null, import_react97.default.createElement(space_default, { size: "middle" }, (s == null ? void 0 : s.name) && import_react97.default.createElement(typography_default.Text, { strong: true }, s.name), (s == null ? void 0 : s.avatar) && import_react97.default.createElement(avatar_default, { src: s == null ? void 0 : s.avatar, alt: s == null ? void 0 : s.name }))));
}, "ThemedHeaderV2");
var Xs = t(({ children: e2, Header: o2, Sider: n2, Title: r, Footer: s, OffLayoutArea: l, initialSiderCollapsed: i }) => {
  let d = grid_default.useBreakpoint(), c = n2 ?? Ro, y = o2 ?? Uo, p = typeof d.sm > "u" ? true : d.sm, P = !!c({ Title: r });
  return import_react95.default.createElement(ho, { initialSiderCollapsed: i }, import_react95.default.createElement(layout_default, { style: { minHeight: "100vh" }, hasSider: P }, import_react95.default.createElement(c, { Title: r }), import_react95.default.createElement(layout_default, null, import_react95.default.createElement(y, null), import_react95.default.createElement(layout_default.Content, null, import_react95.default.createElement("div", { style: { minHeight: 360, padding: p ? 24 : 12 } }, e2), l && import_react95.default.createElement(l, null)), s && import_react95.default.createElement(s, null))));
}, "ThemedLayoutV2");
var sa = "Refine Project";
var aa = import_react98.default.createElement("svg", { width: 24, height: 24, viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, import_react98.default.createElement("path", { fillRule: "evenodd", clipRule: "evenodd", d: "M13.7889 0.422291C12.6627 -0.140764 11.3373 -0.140764 10.2111 0.422291L2.21115 4.42229C0.85601 5.09986 0 6.48491 0 8V16C0 17.5151 0.85601 18.9001 2.21115 19.5777L10.2111 23.5777C11.3373 24.1408 12.6627 24.1408 13.7889 23.5777L21.7889 19.5777C23.144 18.9001 24 17.5151 24 16V8C24 6.48491 23.144 5.09986 21.7889 4.42229L13.7889 0.422291ZM8 8C8 5.79086 9.79086 4 12 4C14.2091 4 16 5.79086 16 8V16C16 18.2091 14.2091 20 12 20C9.79086 20 8 18.2091 8 16V8Z", fill: "currentColor" }), import_react98.default.createElement("path", { d: "M14 8C14 9.10457 13.1046 10 12 10C10.8954 10 10 9.10457 10 8C10 6.89543 10.8954 6 12 6C13.1046 6 14 6.89543 14 8Z", fill: "currentColor" }));
var ce = t(({ collapsed: e2, icon: o2 = aa, text: n2 = sa, wrapperStyles: r }) => {
  let { token: s } = theme_default.useToken(), l = ee(), i = yt(), { Link: d } = ae();
...
var Ao = t(({ resource: e2, resourceNameOrRouteName: o2, hideText: n2 = false, accessControl: r, meta: s, children: l, onClick: i, ...d }) => {
  let c = (0, import_react99.useContext)(ct), y = (r == null ? void 0 : r.enabled) ?? c.options.buttons.enableAccessControl, p = (r == null ? void 0 : r.hideIfUnauthorized) ?? c.options.buttons.hideIfUnauthorized, P = _(), T = ee(), x = yt(), { Link: F } = ae(), u = T === "legacy" ? F : x, { createUrl: f } = me(), { resource: h } = $(e2 ?? o2), { data: m } = Ws({ resource: h == null ? void 0 : h.name, action: "create", queryOptions: { enabled: y }, params: { resource: h } }), C = t(() => m != null && m.can ? "" : m != null && m.reason ? m.reason : P("buttons.notAccessTitle", "You don't have permission to access"), "createButtonDisabledTitle"), a = h ? f(h, s) : "";
...
var Oo = t(({ resource: e2, resourceNameOrRouteName: o2, recordItemId: n2, hideText: r = false, accessControl: s, meta: l, children: i, onClick: d, ...c }) => {
  let y = (0, import_react100.useContext)(ct), p = (s == null ? void 0 : s.enabled) ?? y.options.buttons.enableAccessControl, P = (s == null ? void 0 : s.hideIfUnauthorized) ?? y.options.buttons.hideIfUnauthorized, T = _(), x = ee(), F = yt(), { Link: u } = ae(), f = x === "legacy" ? u : F, { editUrl: h } = me(), { id: m, resource: C } = $(e2 ?? o2), { data: a } = Ws({ resource: C == null ? void 0 : C.name, action: "edit", params: { id: n2 ?? m, resource: C }, queryOptions: { enabled: p } }), S2 = t(() => a != null && a.can ? "" : a != null && a.reason ? a.reason : T("buttons.notAccessTitle", "You don't have permission to access"), "createButtonDisabledTitle"), v = C && (n2 ?? m) ? h(C, n2 ?? m, l) : "";
...
var Ye = t(({ resource: e2, resourceNameOrRouteName: o2, recordItemId: n2, onSuccess: r, mutationMode: s, children: l, successNotification: i, errorNotification: d, hideText: c = false, accessControl: y, metaData: p, meta: P, dataProviderName: T, confirmTitle: x, confirmOkText: F, confirmCancelText: u, invalidates: f, ...h }) => {
  let m = (0, import_react101.useContext)(ct), C = (y == null ? void 0 : y.enabled) ?? m.options.buttons.enableAccessControl, a = (y == null ? void 0 : y.hideIfUnauthorized) ?? m.options.buttons.hideIfUnauthorized, S2 = _(), { id: v, resource: B, identifier: k } = $(e2 ?? o2), { mutationMode: g } = ze(), D = s ?? g, { mutate: R, isLoading: E, variables: z2 } = Pa(), { data: b } = Ws({ resource: B == null ? void 0 : B.name, action: "delete", params: { id: n2 ?? v, resource: B }, queryOptions: { enabled: C } }), W = t(() => b != null && b.can ? "" : b != null && b.reason ? b.reason : S2("buttons.notAccessTitle", "You don't have permission to access"), "disabledTitle"), { setWarnWhen: O } = Ht();
  return C && a && !(b != null && b.can) ? null : import_react101.default.createElement(popconfirm_default, { key: "delete", okText: F ?? S2("buttons.delete", "Delete"), cancelText: u ?? S2("buttons.cancel", "Cancel"), okType: "danger", title: x ?? S2("buttons.confirm", "Are you sure?"), okButtonProps: { disabled: E }, onConfirm: () => {
  ...
  }, disabled: typeof (h == null ? void 0 : h.disabled) < "u" ? h.disabled : (b == null ? void 0 : b.can) === false }, import_react101.default.createElement(button_default, { danger: true, loading: (n2 ?? v) === (z2 == null ? void 0 : z2.id) && E, icon: import_react101.default.createElement(DeleteOutlined_default, null), title: W(), disabled: (b == null ? void 0 : b.can) === false, className: n.DeleteButton, ...h }, !c && (l ?? S2("buttons.delete", "Delete"))));
}, "DeleteButton");
var _e = t(({ resource: e2, resourceNameOrRouteName: o2, recordItemId: n2, hideText: r = false, dataProviderName: s, children: l, onClick: i, meta: d, metaData: c, ...y }) => {
  let p = _(), P = useQueryClient(), T = be(), { resources: x, identifier: F, id: u } = $(e2 ?? o2), f = !!P.isFetching({ queryKey: Eo(F, z(F, s, x)).detail(n2 ?? u) }), h = t(() => {
...
var yi = t(({ resource: e2, resourceNameOrRouteName: o2, recordItemId: n2, hideText: r = false, accessControl: s, meta: l, children: i, onClick: d, ...c }) => {
  let y = (0, import_react103.useContext)(ct), p = (s == null ? void 0 : s.enabled) ?? y.options.buttons.enableAccessControl, P = (s == null ? void 0 : s.hideIfUnauthorized) ?? y.options.buttons.hideIfUnauthorized, { showUrl: T } = me(), x = ee(), F = yt(), { Link: u } = ae(), f = x === "legacy" ? u : F, h = _(), { id: m, resource: C } = $(e2 ?? o2), { data: a } = Ws({ resource: C == null ? void 0 : C.name, action: "show", params: { id: n2 ?? m, resource: C }, queryOptions: { enabled: p } }), S2 = t(() => a != null && a.can ? "" : a != null && a.reason ? a.reason : h("buttons.notAccessTitle", "You don't have permission to access"), "createButtonDisabledTitle"), v = C && (n2 || m) ? T(C, n2 ?? m, l) : "";
  return p && P && !(a != null && a.can) ? null : import_react103.default.createElement(f, { to: v, replace: false, onClick: (B) => {
    ...
    d && (B.preventDefault(), d(B));
  } }, import_react103.default.createElement(button_default, { icon: import_react103.default.createElement(EyeOutlined_default, null), disabled: (a == null ? void 0 : a.can) === false, title: S2(), className: n.ShowButton, ...c }, !r && (i ?? h("buttons.show", "Show"))));
}, "ShowButton");
var Ze = t(({ resource: e2, resourceNameOrRouteName: o2, hideText: n2 = false, accessControl: r, meta: s, children: l, onClick: i, ...d }) => {
  var B;
  let c = (0, import_react104.useContext)(ct), y = (r == null ? void 0 : r.enabled) ?? c.options.buttons.enableAccessControl, p = (r == null ? void 0 : r.hideIfUnauthorized) ?? c.options.buttons.hideIfUnauthorized, { listUrl: P } = me(), T = ee(), x = yt(), { Link: F } = ae(), u = Lt(), f = T === "legacy" ? F : x, h = _(), { resource: m, identifier: C } = $(e2 ?? o2), { data: a } = Ws({ resource: m == null ? void 0 : m.name, action: "list", queryOptions: { enabled: y }, params: { resource: m } }), S2 = t(() => a != null && a.can ? "" : a != null && a.reason ? a.reason : h("buttons.notAccessTitle", "You don't have permission to access"), "createButtonDisabledTitle"), v = m ? P(m, s) : "";
  ...
  } }, import_react104.default.createElement(button_default, { icon: import_react104.default.createElement(BarsOutlined_default, null), disabled: (a == null ? void 0 : a.can) === false, title: S2(), className: n.ListButton, ...d }, !n2 && (l ?? h(`${C ?? e2 ?? o2}.titles.list`, u(((B = m == null ? void 0 : m.meta) == null ? void 0 : B.label) ?? (m == null ? void 0 : m.label) ?? C ?? S(e2, o2), "plural")))));
}, "ListButton");
var Ai = t(({ hideText: e2 = false, children: o2, ...n2 }) => {
  let r = _();
...
var ol = t(({ resourceNameOrRouteName: e2, resource: o2, recordItemId: n2, hideText: r = false, accessControl: s, meta: l, children: i, onClick: d, ...c }) => {
  let y = (0, import_react107.useContext)(ct), p = (s == null ? void 0 : s.enabled) ?? y.options.buttons.enableAccessControl, P = (s == null ? void 0 : s.hideIfUnauthorized) ?? y.options.buttons.hideIfUnauthorized, { cloneUrl: T } = me(), x = ee(), F = yt(), { Link: u } = ae(), f = x === "legacy" ? u : F, h = _(), { id: m, resource: C } = $(o2 ?? e2), { data: a } = Ws({ resource: C == null ? void 0 : C.name, action: "create", params: { id: n2 ?? m, resource: C }, queryOptions: { enabled: p } }), S2 = t(() => a != null && a.can ? "" : a != null && a.reason ? a.reason : h("buttons.notAccessTitle", "You don't have permission to access"), "createButtonDisabledTitle"), v = C && (n2 || m) ? T(C, n2 ?? m, l) : "";
  return p && P && !(a != null && a.can) ? null : import_react107.default.createElement(f, { to: v, replace: false, onClick: (B) => {
    ...
    d && (B.preventDefault(), d(B));
  } }, import_react107.default.createElement(button_default, { icon: import_react107.default.createElement(PlusSquareOutlined_default, null), disabled: (a == null ? void 0 : a.can) === false, title: S2(), className: n.CloneButton, ...c }, !r && (i ?? h("buttons.clone", "Clone"))));
}, "CloneButton");
var ll = t(({ uploadProps: e2, buttonProps: o2, hideText: n2 = false, children: r }) => {
  let s = _();
...
var yl = t(({ canCreate: e2, title: o2, children: n2, createButtonProps: r, resource: s, wrapperProps: l, contentProps: i, headerProps: d, breadcrumb: c, headerButtonProps: y, headerButtons: p }) => {
  var S2, v;
  let P = _(), { options: { breadcrumb: T } = {} } = oe(), x = ee(), F = Lt(), { resource: u, identifier: f } = $(s), h = e2 ?? (((u == null ? void 0 : u.canCreate) ?? !!(u != null && u.create)) || r), m = typeof c > "u" ? T : c, C = h ? { size: "middle", resource: x === "legacy" ? u == null ? void 0 : u.route : f, ...r } : void 0, a = h ? import_react109.default.createElement(Ao, { ...C }) : null;
...
var Sl = t(({ title: e2, saveButtonProps: o2, children: n2, resource: r, isLoading: s = false, breadcrumb: l, wrapperProps: i, headerProps: d, contentProps: c, headerButtonProps: y, headerButtons: p, footerButtonProps: P, footerButtons: T, goBack: x }) => {
  var D, R;
  let F = _(), { options: { breadcrumb: u } = {} } = oe(), f = ee(), h = mo(), { goBack: m } = me(), C = Lt(), { resource: a, action: S2, identifier: v } = $(r), B = typeof l > "u" ? u : l, k = { ...s ? { disabled: true } : {}, ...o2, htmlType: "submit" }, g = import_react110.default.createElement(import_react110.default.Fragment, null, import_react110.default.createElement(Xe, { ...k }));
  return import_react110.default.createElement("div", { ...i ?? {} }, import_react110.default.createElement(Se, { ghost: false, backIcon: x, onBack: S2 !== "list" || typeof S2 < "u" ? f === "legacy" ? m : h : void 0, title: e2 ?? F(`${v}.titles.create`, `Create ${C(((D = a == null ? void 0 : a.meta) == null ? void 0 : D.label) ?? ((R = a == null ? void 0 : a.options) == null ? void 0 : R.label) ?? (a == null ? void 0 : a.label) ?? v, "singular")}`), breadcrumb: typeof B < "u" ? import_react110.default.createElement(import_react110.default.Fragment, null, B) ?? void 0 : import_react110.default.createElement(Be, null), extra: import_react110.default.createElement(space_default, { wrap: true, ...y ?? {} }, p ? typeof p == "function" ? p({ defaultButtons: null }) : p : null), ...d ?? {} }, import_react110.default.createElement(spin_default, { spinning: s }, import_react110.default.createElement(card_default, { bordered: false, actions: [import_react110.default.createElement(space_default, { key: "action-buttons", style: { float: "right", marginRight: 24 }, ...P ?? {} }, T ? typeof T == "function" ? T({ defaultButtons: g, saveButtonProps: k }) : T : g)], ...c ?? {} }, n2))));
}, "Create");
var Ol = t(({ title: e2, saveButtonProps: o2, mutationMode: n2, recordItemId: r, children: s, deleteButtonProps: l, canDelete: i, resource: d, isLoading: c = false, dataProviderName: y, breadcrumb: p, wrapperProps: P, headerProps: T, contentProps: x, headerButtonProps: F, headerButtons: u, footerButtonProps: f, footerButtons: h, goBack: m, autoSaveProps: C }) => {
  var J, ne, ee2;
  let a = _(), { options: { breadcrumb: S2 } = {} } = oe(), { mutationMode: v } = ze(), B = n2 ?? v, k = ee(), g = mo(), D = fe(), { goBack: R, list: E } = me(), z2 = Lt(), { resource: b, action: W, id: O, identifier: U } = $(d), A = Ki({ resource: b, action: "list" }), X = r ?? O, L = typeof p > "u" ? S2 : p, I = (b == null ? void 0 : b.list) && !r, M = i ?? ((((J = b == null ? void 0 : b.meta) == null ? void 0 : J.canDelete) ?? (b == null ? void 0 : b.canDelete)) || l), j = I ? { ...c ? { disabled: true } : {}, resource: k === "legacy" ? b == null ? void 0 : b.route : U } : void 0, _2 = { ...c ? { disabled: true } : {}, resource: k === "legacy" ? b == null ? void 0 : b.route : U, recordItemId: X, dataProviderName: y }, $2 = M ? { ...c ? { disabled: true } : {}, resource: k === "legacy" ? b == null ? void 0 : b.route : U, mutationMode: B, onSuccess: () => {
    k === "legacy" ? E((b == null ? void 0 : b.route) ?? (b == null ? void 0 : b.name) ?? "") : D({ to: A });
  }, recordItemId: X, dataProviderName: y, ...l } : void 0, H = { ...c ? { disabled: true } : {}, ...o2 }, q = import_react111.default.createElement(import_react111.default.Fragment, null, C && import_react111.default.createElement(Vt, { ...C }), I && import_react111.default.createElement(Ze, { ...j }), import_react111.default.createElement(_e, { ..._2 })), K = import_react111.default.createElement(import_react111.default.Fragment, null, M && import_react111.default.createElement(Ye, { ...$2 }), import_react111.default.createElement(Xe, { ...H }));
  return import_react111.default.createElement("div", { ...P ?? {} }, import_react111.default.createElement(Se, { ghost: false, backIcon: m, onBack: W !== "list" && typeof W < "u" ? k === "legacy" ? R : g : void 0, title: e2 ?? a(`${U}.titles.edit`, `Edit ${z2(((ne = b == null ? void 0 : b.meta) == null ? void 0 : ne.label) ?? ((ee2 = b == null ? void 0 : b.options) == null ? void 0 : ee2.label) ?? (b == null ? void 0 : b.label) ?? U, "singular")}`), extra: import_react111.default.createElement(space_default, { wrap: true, ...F ?? {} }, u ? typeof u == "function" ? u({ defaultButtons: q, listButtonProps: j, refreshButtonProps: _2 }) : u : q), breadcrumb: typeof L < "u" ? import_react111.default.createElement(import_react111.default.Fragment, null, L) ?? void 0 : import_react111.default.createElement(Be, null), ...T ?? {} }, import_react111.default.createElement(spin_default, { spinning: c }, import_react111.default.createElement(card_default, { bordered: false, actions: [import_react111.default.createElement(space_default, { key: "footer-buttons", wrap: true, style: { float: "right", marginRight: 24 }, ...f ?? {} }, h ? typeof h == "function" ? h({ defaultButtons: K, deleteButtonProps: $2, saveButtonProps: H }) : h : K)], ...x ?? {} }, s))));
}, "Edit");
var _l = t(({ title: e2, canEdit: o2, canDelete: n2, isLoading: r = false, children: s, resource: l, recordItemId: i, dataProviderName: d, breadcrumb: c, contentProps: y, headerProps: p, wrapperProps: P, headerButtons: T, footerButtons: x, footerButtonProps: F, headerButtonProps: u, goBack: f }) => {
  var _2, $2, H;
  let h = _(), { options: { breadcrumb: m } = {} } = oe(), C = ee(), a = mo(), S2 = fe(), { goBack: v, list: B } = me(), k = Lt(), { resource: g, action: D, id: R, identifier: E } = $(l), z2 = Ki({ resource: g, action: "list" }), b = i ?? R, W = typeof c > "u" ? m : c, O = (g == null ? void 0 : g.list) && !i, U = n2 ?? ((_2 = g == null ? void 0 : g.meta) == null ? void 0 : _2.canDelete) ?? (g == null ? void 0 : g.canDelete), A = o2 ?? (g == null ? void 0 : g.canEdit) ?? !!(g != null && g.edit), X = O ? { resource: C === "legacy" ? g == null ? void 0 : g.route : E } : void 0, L = A ? { ...r ? { disabled: true } : {}, type: "primary", resource: C === "legacy" ? g == null ? void 0 : g.route : E, recordItemId: b } : void 0, I = U ? { ...r ? { disabled: true } : {}, resource: C === "legacy" ? g == null ? void 0 : g.route : E, recordItemId: b, onSuccess: () => {
    C === "legacy" ? B((g == null ? void 0 : g.route) ?? (g == null ? void 0 : g.name) ?? "") : S2({ to: z2 });
  }, dataProviderName: d } : void 0, M = { ...r ? { disabled: true } : {}, resource: C === "legacy" ? g == null ? void 0 : g.route : E, recordItemId: b, dataProviderName: d }, j = import_react112.default.createElement(import_react112.default.Fragment, null, O && import_react112.default.createElement(Ze, { ...X }), A && import_react112.default.createElement(Oo, { ...L }), U && import_react112.default.createElement(Ye, { ...I }), import_react112.default.createElement(_e, { ...M }));
  return import_react112.default.createElement("div", { ...P ?? {} }, import_react112.default.createElement(Se, { ghost: false, backIcon: f, onBack: D !== "list" && typeof D < "u" ? C === "legacy" ? v : a : void 0, title: e2 ?? h(`${E}.titles.show`, `Show ${k((($2 = g == null ? void 0 : g.meta) == null ? void 0 : $2.label) ?? ((H = g == null ? void 0 : g.options) == null ? void 0 : H.label) ?? (g == null ? void 0 : g.label) ?? E, "singular")}`), extra: import_react112.default.createElement(space_default, { key: "extra-buttons", wrap: true, ...u ?? {} }, T ? typeof T == "function" ? T({ defaultButtons: j, deleteButtonProps: I, editButtonProps: L, listButtonProps: X, refreshButtonProps: M }) : T : j), breadcrumb: typeof W < "u" ? import_react112.default.createElement(import_react112.default.Fragment, null, W) ?? void 0 : import_react112.default.createElement(Be, null), ...p ?? {} }, import_react112.default.createElement(spin_default, { spinning: r }, import_react112.default.createElement(card_default, { bordered: false, actions: x ? [import_react112.default.createElement(space_default, { key: "footer-buttons", wrap: true, ...F }, typeof x == "function" ? x({ defaultButtons: null }) : x)] : void 0, ...y ?? {} }, s))));
}, "Show");
var Jl = t(({ value: e2, ...o2 }) => import_react113.default.createElement(typography_default.Text, { ...o2 }, e2), "TextField");
var tp = t(({ value: e2, ...o2 }) => import_react114.default.createElement(tag_default, { ...o2 }, e2 == null ? void 0 : e2.toString()), "TagField");
var sp = t(({ value: e2, ...o2 }) => import_react115.default.createElement(typography_default.Link, { href: `mailto:${e2}`, ...o2 }, e2), "EmailField");
var lp = t(({ value: e2, imageTitle: o2, ...n2 }) => import_react116.default.createElement(image_default, { ...n2, src: e2, title: o2 }), "ImageField");
var mp = t(({ value: e2, valueLabelTrue: o2 = "true", valueLabelFalse: n2 = "false", trueIcon: r = import_react117.default.createElement(CheckOutlined_default, null), falseIcon: s = import_react117.default.createElement(CloseOutlined_default, null), ...l }) => import_react117.default.createElement(tooltip_default, { title: e2 ? o2 : n2, ...l }, e2 ? import_react117.default.createElement("span", null, r) : import_react117.default.createElement("span", null, s)), "BooleanField");
var Tp = t(({ value: e2, locales: o2, format: n2 = "L", ...r }) => {
  import_dayjs5.default.extend(import_localizedFormat.default);
  let s = import_dayjs5.default.locale();
  return import_react118.default.createElement(typography_default.Text, { ...r }, (0, import_dayjs5.default)(e2).locale(o2 || s).format(n2));
}, "DateField");
var bp = t(({ title: e2, src: o2, ...n2 }) => import_react119.default.createElement(Ko, { value: o2, title: e2, ...n2 }, e2 ?? o2), "FileField");
var Ko = t(({ children: e2, value: o2, ...n2 }) => import_react120.default.createElement(typography_default.Link, { href: o2, ...n2 }, e2 ?? o2), "UrlField");
function Fp() {
  return !!(typeof Intl == "object" && Intl && typeof Intl.NumberFormat == "function");
}
t(Fp, "toLocaleStringSupportsOptions");
var Bp = t(({ value: e2, locale: o2, options: n2, ...r }) => {
  let s = Number(e2);
  return import_react121.default.createElement(typography_default.Text, { ...r }, Fp() ? s.toLocaleString(o2, n2) : s);
}, "NumberField");
var kp = t(({ value: e2 = "" }) => import_react122.default.createElement(import_react_markdown.default, { remarkPlugins: [import_remark_gfm.default] }, e2), "MarkdownField");
var Up = t((e2) => {
  ...
  }, "onFilter"), T = t((u) => s ? s(u) : u, "mappedValue"), x = t((u) => {
    if (typeof u == "object") {
      if (Array.isArray(u)) {
        let a = T(u);
        return c(a), o2(a);
      }
      let h = !u || !u.target || import_dayjs6.default.isDayjs(u) ? { target: { value: u } } : u, { target: m } = h, C = T(m.value);
      c(C);
      return;
    }
    let f = T(u);
    c(f);
  }, "onChange"), F = import_react123.default.Children.map(i, (u) => import_react123.default.isValidElement(u) ? import_react123.default.cloneElement(u, { onChange: x, value: T(d) }) : u);
...
var Gp = t(() => {
  let [e2, o2] = (0, import_react124.useState)(), n2 = _(), { push: r } = me(), s = fe(), l = ee(), { resource: i, action: d } = $();
  ...
  }, [i, d]), import_react124.default.createElement(result_default, { status: "404", title: "404", extra: import_react124.default.createElement(space_default, { direction: "vertical", size: "large" }, import_react124.default.createElement(space_default, null, import_react124.default.createElement(typography_default.Text, null, n2("pages.error.404", "Sorry, the page you visited does not exist.")), e2 && import_react124.default.createElement(tooltip_default, { title: e2 }, import_react124.default.createElement(InfoCircleOutlined_default, {}))), import_react124.default.createElement(button_default, { type: "primary", onClick: () => {
    l === "legacy" ? r("/") : s({ to: "/" });
  } }, n2("pages.error.backHome", "Back Home"))) });
}, "ErrorComponent");
var Nt = { background: "radial-gradient(50% 50% at 50% 50%, #63386A 0%, #310438 100%)", backgroundSize: "cover" };
var Qt = { maxWidth: "408px", margin: "auto" };
var zt = { textAlign: "center", color: "#626262", fontSize: "30px", letterSpacing: "-0.04em" };
var Wt = { display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "28px" };
var tu = t(() => {
  let [e2] = form_default.useForm(), o2 = _(), n2 = Y(), { mutate: r, isLoading: s } = $t({ v3LegacyAuthProviderCompatible: !!(n2 != null && n2.isLegacy) }), l = import_react125.default.createElement(typography_default.Title, { level: 3, style: zt }, o2("pages.login.title", "Sign in your account"));
  return import_react125.default.createElement(layout_default, { style: Nt }, import_react125.default.createElement(row_default, { justify: "center", align: "middle", style: { height: "100vh" } }, import_react125.default.createElement(col_default, { xs: 22 }, import_react125.default.createElement("div", { style: Qt }, import_react125.default.createElement("div", { style: Wt }, import_react125.default.createElement("img", { src: "https://refine.ams3.cdn.digitaloceanspaces.com/logo/refine.svg", alt: "Refine Logo" })), import_react125.default.createElement(card_default, { title: l, headStyle: { borderBottom: 0 } }, import_react125.default.createElement(form_default, { layout: "vertical", form: e2, onFinish: (i) => {
    r(i);
...
var Yo = t(({ providers: e2, loginLink: o2, wrapperProps: n2, contentProps: r, renderContent: s, formProps: l, title: i, hideForm: d }) => {
  let { token: c } = theme_default.useToken(), [y] = form_default.useForm(), p = _(), P = ee(), T = yt(), { Link: x } = ae(), F = P === "legacy" ? x : T, u = Y(), { mutate: f, isLoading: h } = qr({ v3LegacyAuthProviderCompatible: !!(u != null && u.isLegacy) }), m = i === false ? null : import_react129.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, i ?? import_react129.default.createElement(ce, { collapsed: false })), C = import_react129.default.createElement(typography_default.Title, { level: 3, style: { color: c.colorPrimaryTextHover, ...Ee } }, p("pages.register.title", "Sign up for your account")), a = t(() => e2 && e2.length > 0 ? import_react129.default.createElement(import_react129.default.Fragment, null, e2.map((v) => import_react129.default.createElement(button_default, { key: v.name, type: "default", block: true, icon: v.icon, style: { display: "flex", justifyContent: "center", alignItems: "center", width: "100%", marginBottom: "8px" }, onClick: () => f({ providerName: v.name }) }, v.label)), !d && import_react129.default.createElement(divider_default, null, import_react129.default.createElement(typography_default.Text, { style: { color: c.colorTextLabel } }, p("pages.login.divider", "or")))) : null, "renderProviders"), S2 = import_react129.default.createElement(card_default, { title: C, headStyle: ke, bodyStyle: De, style: { ...Le, backgroundColor: c.colorBgElevated }, ...r ?? {} }, a(), !d && import_react129.default.createElement(form_default, { layout: "vertical", form: y, onFinish: (v) => f(v), requiredMark: false, ...l }, import_react129.default.createElement(form_default.Item, { name: "email", label: p("pages.register.email", "Email"), rules: [{ required: true }, { type: "email", message: p("pages.register.errors.validEmail", "Invalid email address") }] }, import_react129.default.createElement(input_default, { size: "large", placeholder: p("pages.register.fields.email", "Email") })), import_react129.default.createElement(form_default.Item, { name: "password", label: p("pages.register.fields.password", "Password"), rules: [{ required: true }] }, import_react129.default.createElement(input_default, { type: "password", placeholder: "●●●●●●●●", size: "large" })), import_react129.default.createElement("div", { style: { display: "flex", justifyContent: "space-between", marginBottom: "24px" } }, o2 ?? import_react129.default.createElement(typography_default.Text, { style: { fontSize: 12, marginLeft: "auto" } }, p("pages.login.buttons.haveAccount", "Have an account?"), " ", import_react129.default.createElement(F, { style: { fontWeight: "bold", color: c.colorPrimaryTextHover }, to: "/login" }, p("pages.login.signin", "Sign in")))), import_react129.default.createElement(form_default.Item, { style: { marginBottom: 0 } }, import_react129.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: h, block: true }, p("pages.register.buttons.submit", "Sign up")))), d && o2 !== false && import_react129.default.createElement("div", { style: { marginTop: d ? 16 : 8 } }, import_react129.default.createElement(typography_default.Text, { style: { fontSize: 12 } }, p("pages.login.buttons.haveAccount", "Have an account?"), " ", import_react129.default.createElement(F, { style: { fontWeight: "bold", color: c.colorPrimaryTextHover }, to: "/login" }, p("pages.login.signin", "Sign in")))));
...
var _o = t(({ loginLink: e2, wrapperProps: o2, contentProps: n2, renderContent: r, formProps: s, title: l }) => {
  let { token: i } = theme_default.useToken(), [d] = form_default.useForm(), c = _(), y = ee(), p = yt(), { Link: P } = ae(), T = y === "legacy" ? P : p, { mutate: x, isLoading: F } = to(), u = l === false ? null : import_react130.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, l ?? import_react130.default.createElement(ce, { collapsed: false })), f = import_react130.default.createElement(typography_default.Title, { level: 3, style: { color: i.colorPrimaryTextHover, ...Ee } }, c("pages.forgotPassword.title", "Forgot your password?")), h = import_react130.default.createElement(card_default, { title: f, headStyle: ke, bodyStyle: De, style: { ...Le, backgroundColor: i.colorBgElevated }, ...n2 ?? {} }, import_react130.default.createElement(form_default, { layout: "vertical", form: d, onFinish: (m) => x(m), requiredMark: false, ...s }, import_react130.default.createElement(form_default.Item, { name: "email", label: c("pages.forgotPassword.fields.email", "Email"), rules: [{ required: true }, { type: "email", message: c("pages.forgotPassword.errors.validEmail", "Invalid email address") }] }, import_react130.default.createElement(input_default, { type: "email", size: "large", placeholder: c("pages.forgotPassword.fields.email", "Email") })), import_react130.default.createElement("div", { style: { display: "flex", justifyContent: "space-between" } }, e2 ?? import_react130.default.createElement(typography_default.Text, { style: { fontSize: 12, marginLeft: "auto" } }, c("pages.register.buttons.haveAccount", "Have an account? "), " ", import_react130.default.createElement(T, { style: { fontWeight: "bold", color: i.colorPrimaryTextHover }, to: "/login" }, c("pages.login.signin", "Sign in")))), import_react130.default.createElement(form_default.Item, { style: { marginTop: "24px", marginBottom: 0 } }, import_react130.default.createElement(button_default, { type: "primary", size: "large", htmlType: "submit", loading: F, block: true }, c("pages.forgotPassword.buttons.submit", "Send reset instructions")))));
  return import_react130.default.createElement(layout_default, { style: ve, ...o2 ?? {} }, import_react130.default.createElement(row_default, { justify: "center", align: "middle", style: { padding: "16px 0", minHeight: "100dvh" } }, import_react130.default.createElement(col_default, { xs: 22 }, r ? r(h, u) : import_react130.default.createElement(import_react130.default.Fragment, null, u, h))));
}, "ForgotPasswordPage");
var Zo = t(({ wrapperProps: e2, contentProps: o2, renderContent: n2, formProps: r, title: s }) => {
  let { token: l } = theme_default.useToken(), [i] = form_default.useForm(), d = _(), c = Y(), { mutate: y, isLoading: p } = oo({ v3LegacyAuthProviderCompatible: !!(c != null && c.isLegacy) }), P = s === false ? null : import_react131.default.createElement("div", { style: { display: "flex", justifyContent: "center", marginBottom: "32px", fontSize: "20px" } }, s ?? import_react131.default.createElement(ce, { collapsed: false })), T = import_react131.default.createElement(typography_default.Title, { level: 3, style: { color: l.colorPrimaryTextHover, ...Ee } }, d("pages.updatePassword.title", "Set New Password")), x = import_react131.default.createElement(card_default, { title: T, headStyle: ke, bodyStyle: De, style: { ...Le, backgroundColor: l.colorBgElevated }, ...o2 ?? {} }, import_react131.default.createElement(form_default, { layout: "vertical", form: i, onFinish: (F) => y(F), requiredMark: false, ...r }, import_react131.default.createElement(form_default.Item, { name: "password", label: d("pages.updatePassword.fields.password", "New Password"), rules: [{ required: true }], style: { marginBottom: "12px" } }, import_react131.default.createElement(input_default, { type: "password", placeholder: "●●●●●●●●", size: "large" })), import_react131.default.createElement(form_default.Item, { name: "confirmPassword", label: d("pages.updatePassword.fields.confirmPassword", "Confirm New Password"), hasFeedback: true, dependencies: ["password"], rules: [{ required: true }, ({ getFieldValue: F }) => ({ validator(u, f) {
  ...
  return import_react131.default.createElement(layout_default, { style: ve, ...e2 ?? {} }, import_react131.default.createElement(row_default, { justify: "center", align: "middle", style: { padding: "16px 0", minHeight: "100dvh" } }, import_react131.default.createElement(col_default, { xs: 22 }, n2 ? n2(x, P) : import_react131.default.createElement(import_react131.default.Fragment, null, P, x))));
}, "UpdatePasswordPage");
var id = t((e2) => {
  let { type: o2 } = e2;
...
var Be = t(({ breadcrumbProps: e2, showHome: o2 = true, hideIcons: n2 = false, meta: r }) => {
  let s = ee(), { breadcrumbs: l } = Bb({ meta: r }), i = yt(), { Link: d } = ae(), { hasDashboard: c } = oe(), { resources: y } = $(), p = So("/", y), P = s === "legacy" ? d : i;
  if (l.length === 1)
    return null;
...
var Vt = t(({ status: e2, elements: { success: o2 = import_react134.default.createElement(uo, { key: "autoSave.success", defaultMessage: "saved", icon: import_react134.default.createElement(CheckCircleOutlined_default, null) }), error: n2 = import_react134.default.createElement(uo, { key: "autoSave.error", defaultMessage: "auto save failure", icon: import_react134.default.createElement(ExclamationCircleOutlined_default, null) }), loading: r = import_react134.default.createElement(uo, { key: "autoSave.loading", defaultMessage: "saving...", icon: import_react134.default.createElement(SyncOutlined_default, null) }), idle: s = import_react134.default.createElement(uo, { key: "autoSave.idle", defaultMessage: "waiting for changes", icon: import_react134.default.createElement(EllipsisOutlined_default, null) }) } = {} }) => import_react134.default.createElement(Gu, { status: e2, elements: { success: o2, error: n2, loading: r, idle: s } }), "AutoSaveIndicator");
var uo = t(({ key: e2, defaultMessage: o2, icon: n2 }) => {
  let r = _(), { token: s } = theme_default.useToken();
  return import_react134.default.createElement(typography_default.Text, { style: { marginRight: 5, color: s.colorTextTertiary, fontSize: ".8rem" } }, r(e2, o2), import_react134.default.createElement("span", { style: { marginLeft: ".2rem" } }, n2));
}, "Message");
var kd = t((e2) => {
  let { fileList: o2 } = e2;
  return [...o2];
}, "getValueFromEvent");
var lF = { Blue: { token: { colorPrimary: "#1677FF" } }, Purple: { token: { colorPrimary: "#722ED1" } }, Magenta: { token: { colorPrimary: "#EB2F96" } }, Red: { token: { colorPrimary: "#F5222D" } }, Orange: { token: { colorPrimary: "#FA541C" } }, Yellow: { token: { colorPrimary: "#FAAD14" } }, Green: { token: { colorPrimary: "#52C41A" } } };
export {
  id as AuthPage,
  ...
  Jl as TextField,
  Do as ThemedHeader,
  Uo as ThemedHeaderV2,
  ys as ThemedLayout,
  Ie as ThemedLayoutContext,
  ho as ThemedLayoutContextProvider,
  Xs as ThemedLayoutV2,
  Lo as ThemedSider,
  Ro as ThemedSiderV2,
  ko as ThemedTitle,
  ce as ThemedTitleV2,
  ...
  kd as getValueFromEvent,
  yo as mapAntdFilterToCrudFilter,
  fo as mapAntdSorterToCrudSorting,
  Sy as notificationProvider,
  df as useCheckboxGroup,
  nt as useDrawerForm,
  Nr as useEditableTable,
  Jf as useFileUploadState,
  Te as useForm,
  Uf as useImport,
  et as useModal,
  tt as useModalForm,
  vy as useNotificationProvider,
  Pf as useRadioGroup,
  ef as useSelect,
  uy as useSiderVisible,
  en as useSimpleList,
  st as useStepsForm,
  go as useTable,
  ct2 as useThemedLayoutContext
};
